...
class editarimovelController extends controller {
    ...
    public function index() {
        ...
        //update imovel==============================================
        if (isset($_POST['id_tipo_imovel']) && !empty($_POST['id_tipo_imovel']) || (isset($_POST['id_tipo_assunto']) && !empty($_POST['id_tipo_assunto'])) || (isset($_POST['nivel']) && !empty($_POST['nivel'])) || (isset($_POST['status']) && !empty($_POST['status'])) || (isset($_POST['brevedescricao']) && !empty($_POST['brevedescricao']))) {
