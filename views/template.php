        ...
        <nav class="navbar navbar-inverse ">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a href="https://www.facebook.com/negociosemcabreuva/"><img src="<?php BASE_URL; ?>assets/images/facebookcolor.png" width="32" height="32" style="margin-top: 8px"/></a>
                </div>
...
function pedido(){
    ...
    <footer>
        <div class="rodape">
            IMOVEISEMCABREUVA © 2018 – <?php echo date('Y'); ?> Todos Direitos Reservados. Desenvolvido por Marcel Hoyama
        </div>
    </footer>
