...
<title>Editar Inquilino - DMR Imóveis - Negócios Imobiliários em Cabreúva</title>
<div class="container-fluid">
    <?php     $value = $viewData['dadosInquilino']; ?> 
    <h2 class="text-center h2 label-info">Editar Dados do Inquilino: <?php echo $value['nome'];?></h2></br>
